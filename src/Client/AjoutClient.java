...
public final class AjoutClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ButtonAj.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client/icons8-add-48.png"))); // NOI18N
        ...
        retour.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client/icons8-undo-50.png"))); // NOI18N
    ...
    private void ButtonAjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAjActionPerformed
        ...
        Connection cons = new Connexion().mysql();
        if(nom.getText().isEmpty() || prenom.getText().isEmpty() || sexe.getText().isEmpty() || adresse.getText().isEmpty() || numero.getText().isEmpty() || chambre.getSelectedItem().toString().isEmpty()) {
